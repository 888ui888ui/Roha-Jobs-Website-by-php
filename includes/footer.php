<section>
    ...
    <div class="footer-container">
        ...
        <div class="footer-section">
            ...
            <ul class="social-links">
                ...
                <li><a href="https://www.youtube.com/@EvangadiTech" target="_blank" aria-label="YouTube">
                    <span class="social-icon">▶️</span> YouTube
                </a></li>
                
                <li><a href="your-linkedin-link" target="_blank" aria-label="LinkedIn">
                    <span class="social-icon">🔗</span> LinkedIn
                </a></li>
                
                <li><a href="your-whatsapp-link" target="_blank" aria-label="WhatsApp">
    ...
    <div class="footer-bottom">
        &copy; 2025 RohaJobs. All rights reserved.
    </div>
</footer>
</section>